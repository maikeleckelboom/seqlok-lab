/**
 * @file ESLint configuration for @seqlok/commands (command ring & envelopes).
 * @license MIT
 */
...
/**
 * Directory of the @seqlok/commands package.
 * @type {string}
 */
...
/**
 * Flat ESLint configuration for @seqlok/commands.
 *
 * @type {import("typescript-eslint").ConfigArray}
 */
export default createPackageEslintConfig({
  name: "seqlok/commands",
