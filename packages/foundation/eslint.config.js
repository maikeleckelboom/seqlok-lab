/**
 * @file ESLint configuration for @seqlok/foundation.
 * @license MIT
 */
...
/**
 * Directory of the @seqlok/foundation package.
 * @type {string}
 */
const HERE = dirname(fileURLToPath(import.meta.url));

/**
 * Flat ESLint configuration for @seqlok/foundation.
 *
 * @type {import("typescript-eslint").ConfigArray}
 */
export default createPackageEslintConfig({
  name: "seqlok/foundation",
